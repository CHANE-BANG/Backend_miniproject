					...
					<div class="footer-info">
						...
						<div class="social-links mt-3">
							<a href="https://www.netflix.com/kr/" class="netflix"><i
								class="bx bxs-movie-play"></i></a> <a href="https://watcha.com/home"
								class="watcha"><i class="bx bx-caret-right-square"></i></a> <a
				...
				<div class="col-lg-4 col-md-8 footer-links"
					...
					<ul style="text-align: center; display: inline-block;">
						...
						<li><i class="bx bx-chevron-right"></i> <a href="#">자유게시판</a>
							<i class="bx bx-chevron-right"></i> <a href="list2">영화리뷰</a></li>
						<li><i class="bx bx-chevron-right"></i> <a href="write.jsp">글쓰기&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
							<i class="bx bx-chevron-right"></i> <a href="member/update">마이페이지</a></li>
					</ul>
				</div>

				<div class="col-lg-4 col-md-6 footer-newsletter">
					<h4>영화 찾기</h4>
					<FORM name=watcha_search
						action=https://pedia.watcha.com/ko-KR/search?query= method=get>
						<INPUT type="text" class="search_watcha" size=22 height=10
							placeholder="보고싶은 영화를 검색해보세요" name=query> <INPUT
